  ...
  return (
    <div>
      ...
      <div className="pt-20 flex-col flex justify-center items-center space-y-2">
        <h1 data-aos="fade-down-right"  data-aos-duration="1000" className="text-4xl font-semibold">
          Explore Our Estates Collection
        </h1>
        <p data-aos="fade-down-right"  data-aos-duration="1000" data-aos-delay="1000" className="text-lg text-gray-500">
          Find the epitome of elegance and sophistication among our diverse
          range of estates.
        </p>
      </div>
      <div className="grid grid-cols-1 gap-y-10 md:grid-cols-2  lg:grid-cols-3 py-10 pl-6 lg:pl-0 w-full">
        {estates.map((estate) => (
      ...
      <div className="py-20">
        <div className="flex justify-center items-center flex-col space-y-4 ">
          <h1 data-aos="fade-down-right"  data-aos-duration="1000" className="text-5xl font-semibold text-center">Our Services for You</h1>
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mx-auto ml-10 lg:ml-0 gap-2 justify-between items-center pt-10">
